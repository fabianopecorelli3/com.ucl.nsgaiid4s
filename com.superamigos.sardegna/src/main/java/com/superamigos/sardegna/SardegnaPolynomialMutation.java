...
public class SardegnaPolynomialMutation implements MutationOperator<DoubleSolution> {
  ...
  /** Constructor */
  public SardegnaPolynomialMutation() {
    this(DEFAULT_PROBABILITY, DEFAULT_DISTRIBUTION_INDEX) ;
  }

  /** Constructor */
  public SardegnaPolynomialMutation(DoubleProblem problem, double distributionIndex) {
    this(1.0/problem.getNumberOfVariables(), distributionIndex) ;
  }

  /** Constructor */
  public SardegnaPolynomialMutation(DoubleProblem problem,
  ...
  /** Constructor */
  public SardegnaPolynomialMutation(double mutationProbability, double distributionIndex) {
    this(mutationProbability, distributionIndex, new RepairDoubleSolutionAtBounds()) ;
  }

  /** Constructor */
  public SardegnaPolynomialMutation(double mutationProbability,
                            double distributionIndex,
                            RandomGenerator<Double> randomGenerator) {
  ...
  public SardegnaPolynomialMutation(double mutationProbability, double distributionIndex,
	  ...
	  this(mutationProbability, distributionIndex, solutionRepair, (RandomGenerator<Double> & Serializable)() -> JMetalRandom.getInstance().nextDouble());
  }
