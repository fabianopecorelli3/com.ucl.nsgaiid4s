...
import com.ucl.nsgaiid4s.experiment.component.Contribution;
...
import com.ucl.nsgaiid4s.experiment.component.GenerateLatexTablesWithStatistics;
import com.ucl.nsgaiid4s.experiment.component.GeneratePDFBoxplotsWithR;
import com.ucl.nsgaiid4s.utils.LocalFileManger;
import com.ucl.nsgaiid4s.experiment.component.GenerateNewTimes;
import com.ucl.nsgaiid4s.experiment.component.GeneratePDFPlotsWithR;
import com.ucl.nsgaiid4s.experiment.component.GeneratePDFWilcoxonWithR;
import com.ucl.nsgaiid4s.experiment.component.NSGAIID4SExperimentAlgorithm;
import com.ucl.nsgaiid4s.operator.NSGAIID4SPolynomialMutation;
import com.ucl.nsgaiid4s.operator.NSGAIID4SSBXCrossover;
import com.ucl.nsgaiid4s.rejectpolicy.ReplacementRejectPolicy;
 ...
 * @author fably
 */
public class NSGAIID4SExperimentsRunner {
    ...
    public NSGAIID4SExperimentsRunner() {
    }

    public NSGAIID4SExperimentsRunner(String path, int numberOfPartitions, int k, int independentRuns, int populationSize, int numberOfIterations, boolean locale, int numberOfThreads) {
        this.path = path;
        ...
        Experiment<DoubleSolution, List<DoubleSolution>> experiment
                ...
                .setIndicatorList(Arrays.asList(//new Epsilon<DoubleSolution>(),
                   ...
                   //   new InvertedGenerationalDistancePlus<DoubleSolution>()
                        new Contribution<DoubleSolution>()))
...
//        new GenerateFriedmanTestTables<>(experiment).run();
        ...
        new GeneratePDFPlotsWithR<>(experiment).setRows(1).setColumns(1).run();
        new GeneratePDFWilcoxonWithR<>(experiment).setRows(1).setColumns(1).run();
        new GenerateNewTimes<>(experiment, populationSize * numberOfIterations, numberOfPartitions).run();
    ...
    public List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> configureAlgorithmList(
        ...
        for (int i = 0; i < problemList.size(); i++) {
            Algorithm<List<DoubleSolution>> algorithm = new NSGAIIBuilder<>(
                    ...
                    .build();
            algorithms.add(new NSGAIID4SExperimentAlgorithm<>(algorithm, "jMetal", problemList.get(i).getTag(), fileManager, locale, 1));
            Algorithm<List<DoubleSolution>> sardegna_REPL = new NSGAIID4S<DoubleSolution>(
                    problemList.get(i).getProblem(),
                    ...
                    new NSGAIID4SSBXCrossover(1.0, 5),
                    new NSGAIID4SPolynomialMutation(1.0 / problemList.get(i).getProblem().getNumberOfVariables(), 10.0),
                    numberOfThreads
            );
            algorithms.add(new NSGAIID4SExperimentAlgorithm<>(sardegna_REPL, "REPL", problemList.get(i).getTag(), fileManager, locale, numberOfPartitions));
            ...
            algorithms.add(new NSGAIID4SExperimentAlgorithm<>(sardegna_RR, "RR", problemList.get(i).getTag(), fileManager, locale, numberOfPartitions));
           /* Algorithm<List<DoubleSolution>> sardegna_DR = new NSGAIID4S<DoubleSolution>(
                    problemList.get(i).getProblem(),
                    populationSize * numberOfIterations,
                    k,
                    numberOfPartitions,
            ...
            algorithms.add(new SardegnaExperimentAlgorithm<>(sardegna_DR, "DR", problemList.get(i).getTag(), fileManager, locale, numberOfPartitions));
            Algorithm<List<DoubleSolution>> sardegna_REPR = new NSGAIID4S<DoubleSolution>(
                    problemList.get(i).getProblem(),
                    populationSize * numberOfIterations,
                    k,
                    numberOfPartitions,
            ...
            algorithms.add(new SardegnaExperimentAlgorithm<>(sardegna_REPR, "REPR", problemList.get(i).getTag(), fileManager, locale, numberOfPartitions));
            Algorithm<List<DoubleSolution>> sardegna_RM = new NSGAIID4S<DoubleSolution>(
                    problemList.get(i).getProblem(),
                    populationSize * numberOfIterations,
                    k,
                    numberOfPartitions,
            ...
            algorithms.add(new SardegnaExperimentAlgorithm<>(sardegna_RM, "REM", problemList.get(i).getTag(), fileManager, locale, numberOfPartitions));
        */}
        return algorithms;
    }
