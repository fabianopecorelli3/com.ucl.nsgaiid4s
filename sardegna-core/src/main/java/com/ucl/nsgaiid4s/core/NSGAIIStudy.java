...
public class NSGAIIStudy {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Argomenti mancanti: "+(7-args.length));
        if (args.length != 9) {
...
//    RejectPolicy policy = new RandomReplacementRejectPolicy();
        NSGAIID4SRunner runner = new NSGAIID4SRunner(experimentBaseDirectory, numberOfPartitions, k, independentRuns, populationSize, numberOfIterations, locale, numberOfThreads, delay);
        //SardegnaExperimentsRunner runner = new SardegnaExperimentsRunner(experimentBaseDirectory, numberOfPartitions, k, independentRuns, populationSize, numberOfIterations, locale, numberOfThreads);
