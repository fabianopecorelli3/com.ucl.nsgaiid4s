...
//    RejectPolicy policy = new RandomReplacementRejectPolicy();
        SardegnaRunner runner = new SardegnaRunner(experimentBaseDirectory, numberOfPartitions, k, independentRuns, populationSize, numberOfIterations, locale, numberOfThreads, delay);
