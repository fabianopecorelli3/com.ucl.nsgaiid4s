...
package com.ucl.nsgaiid4s.problem;
...
/** Class representing problem ZDT1 with a computing delay */
...
public class ZDT1 extends AbstractDoubleProblem {
   ...
   */
  public ZDT1(Integer numberOfVariables, Integer delay) {
  ...
  public void evaluate(DoubleSolution solution) {
    ...
    f[1] = h * g;
      ...
      try {
          ...
          Logger.getLogger(ZDT1.class.getName()).log(Level.SEVERE, null, ex);
      }
