    ...
    public List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> configureAlgorithmList(
        ...
        for (int i = 0; i < problemList.size(); i++) {
            Algorithm<List<DoubleSolution>> algorithm = new NSGAIIBuilder<>(
                    ...
                    .build();
            algorithms.add(new NSGAIID4SExperimentAlgorithm<>(algorithm, "jMetal", problemList.get(i).getTag(), fileManager, locale, numberOfPartitions));
            ...
            algorithms.add(new NSGAIID4SExperimentAlgorithm<>(sardegna_REPL, "REPL", problemList.get(i).getTag(), fileManager, locale, 1));
            ...
            algorithms.add(new NSGAIID4SExperimentAlgorithm<>(sardegna_RR, "RR", problemList.get(i).getTag(), fileManager, locale, 1));
