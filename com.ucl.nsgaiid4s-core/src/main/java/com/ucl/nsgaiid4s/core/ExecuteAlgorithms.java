...
public class ExecuteAlgorithms<S extends Solution<?>, Result> implements ExperimentComponent {
     ...
     * Constructor
     */
    public ExecuteAlgorithms(Experiment<S, Result> configuration, FileManager fileManager, boolean local) {
    ...
    public void run() {
        ...
        for (ExperimentAlgorithm ea : experiment.getAlgorithmList()) {
            ...
            fileManager.write(timesFile,((NSGAIID4SExperimentAlgorithm) ea).getTotalExecutionTime());
        }
